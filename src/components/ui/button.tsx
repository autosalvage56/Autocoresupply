  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground font-heading uppercase tracking-[0.15em] text-xs font-700 shadow-[0_10px_30px_-10px_var(--primary)] hover:shadow-[0_14px_36px_-8px_var(--primary)] hover:bg-primary/90 transition-all",
        brass: "bg-accent text-accent-foreground font-heading uppercase tracking-[0.15em] text-xs font-700 hover:bg-accent/90",
